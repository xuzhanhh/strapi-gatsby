...
const SearchModal = React.memo(() => {
  ...
  return (
    <>
      <div className="cursor-pointer justify-between flex flex-1 items-center hover:text-pink-700 border-gray-300 rounded-md border-2 px-4" onClick={() => { setIsOpen(true) }}>
        <div className="flex items-center">
          ...
          <div className="ml-2 text-sm"> Search blogs</div>
        </div>
        <div className="flex">
      ...
      >
        <div className="rounded-full p-5" ref={rootRef}>
          ...
          >
            ...
            <div className="w-full bg-gray-300 mb-3" style={{ height: '0.1rem' }}></div>
            <StyledSearchResult
              indices={indices}
            />
          </InstantSearch>
